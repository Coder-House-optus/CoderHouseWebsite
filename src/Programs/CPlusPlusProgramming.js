  ...
  return (
    ...
    <polyline points="12 19 5 12 12 5"></polyline>
      ...
      <div style={titleStyles1}>
        <h3>Explore the concepts of C++ Programming.</h3>
      </div>

      <img
        src="/images/Roadmaps/C++ Programming_ From Beginner to Expert-roadmap.jpg" // Replace with your C++ roadmap image URL
        alt="C++ Roadmap"
        style={flowchart}
      />
