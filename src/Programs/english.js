    ...
    <polyline points="12 19 5 12 12 5"></polyline>
      ...
      <header style={headerStyles}>
        <img
          ...
          style={logoStyles}
        />
        <h1 style={titleStyles}>English Course</h1>
      </header>

      {/* Main Content */}
      <div style={titleStyles1}>
        <h3>Improve your English language and communication skills.</h3>
      </div>

      <img
        src="/images/Roadmaps/English Topics for Placement Preparation-roadmap.jpg" // Replace with your English roadmap image URL
        alt="English Roadmap"
        style={flowchart}
      />
