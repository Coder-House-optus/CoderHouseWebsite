...
<div className="what-we-offer">
  ...
  <div className="tech-grid">
    <div className="tech-item">
      ...
      <p className="tech-description">Core Java, Advanced Java</p>
    </div>
    <div className="tech-item">
      <img src="/images/Courses/springboot.png" alt="Spring Boot" />
      <p className="tech-description">Spring Boot</p>
    </div>
    <div className="tech-item">
      <img src="/images/Courses/aws.png" alt="AWS" />
      <p className="tech-description">AWS Admin, AWS DevOps</p>
    </div>
    <div className="tech-item">
      <img src="/images/Courses/dot-net-original.png" alt="Dot Net" />
      <p className="tech-description">Dot Net</p>
    </div>
    <div className="tech-item">
      <img src="/images/Courses/azure.png" alt="Azure" />
      <p className="tech-description">Azure Admin | DevOps | Azure Data Engineer</p>
    </div>
    <div className="tech-item">
      <img src="/images/Courses/Python-logo-notext.png" alt="Python" />
      <p className="tech-description">Python, Django, Python Full Stack</p>
    </div>
    <div className="tech-item">
      <img src="/images/Courses/ki.png" alt="SQL" />
      <p className="tech-description">SQL</p>
    </div>
    <div className="tech-item">
      <img src="/images/Courses/New_Power_BI_Logo.png" alt="Power BI" />
      <p className="tech-description">Power BI</p>
    </div>
    <div className="tech-item">
      <img src="/images/Courses/rest-api.png" alt="REST API" />
      <p className="tech-description">REST API</p>
    </div>
    <div className="tech-item">
      <img src="/images/Courses/React_Logo.png" alt="React JS" />
      <p className="tech-description">React JS</p>
    </div>
    <div className="tech-item">
      <img src="/images/Courses/nodejs.png" alt="Node JS" />
      <p className="tech-description">Node JS</p>
    </div>
    <div className="tech-item">
      <img src="/images/Courses/mangodb.png" alt="MongoDB" />
      <p className="tech-description">Mongo DB</p>
    </div>
    <div className="tech-item">
      <img src="/images/Courses/oracle.png" alt="Oracle" />
      <p className="tech-description">Oracle</p>
    </div>
  </div>
</div>
